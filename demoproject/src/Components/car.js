...
export default class Car_LifeCycleOfComponent extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            year: "2021",
            color: "black",
            carImage: "https://imgd.aeplcdn.com/664x374/n/cw/ec/34024/xuv500-exterior-right-front-three-quarter-3.jpeg?q=85",
            Car_price: 2173600,
            show: true
        }
    ...
    componentDidMount() {
        ...
        setTimeout(() => {
            this.setState({
                Car_price: this.state.Car_price + 40000
            })
        }, 2000)
    }
    ...
    render() {
        return (
            <div style={{ backgroundColor: "teal" }}>
                <h1 style={myhead}><marquee>Hello Er. Gaurav Khatri Welcome to React Tutorial!!!</marquee></h1>
                ...
                <table align="center" border="1" style={{
                    backgroundColor: "hotpink", fontSize: 28,
